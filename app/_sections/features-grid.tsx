    ...
    <section className="container mx-auto px-6 flex flex-col gap-10">
      ...
      <div className="grid w-full grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-5">
        {featuresGridList.map(({ _id, title, description, icon }) => (
          <article
            key={_id}
            className="flex flex-col gap-4 rounded-lg border border-[var(--border)] p-4 [box-shadow:_70px_-20px_130px_0px_rgba(255,255,255,0.05)_inset] dark:border-[--dark-border] dark:[box-shadow:_70px_-20px_130px_0px_rgba(255,255,255,0.05)_inset]"
          >
            <figure className="flex size-9 items-center justify-center rounded-full border border-[var(--border)] p-2">
