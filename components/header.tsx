...
export const DesktopMenu = () => {
  const desktopMenu: { links: NavigationMenuListItem[] } = {
    links: [
      ...
      { _id: "2", title: "About", href: "/about" },
      {
        ...
        href: "/services",
        subLinks: [
          { _id: "31", title: "Consulting", href: "/services/consulting", description: "Expert advice to elevate your projects." },
  ...
  return (
    <div>
      <NavigationMenu className={"z-1 relative flex-col justify-center lg:flex"} viewport={false} delayDuration={50}>
