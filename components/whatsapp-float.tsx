...
export default function WhatsAppFloat() {
  ...
  const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '8921190179'; // Replace with actual WhatsApp number
  const message = 'Hi! May i know more details about your DevXtra.';
  ...
  return (
    ...
    >
      ...
      <span
        className={`hidden text-sm md:text-base font-medium whitespace-nowrap overflow-hidden transition-all duration-300 ${
