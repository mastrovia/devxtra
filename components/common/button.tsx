...
export const ButtonStyled: FC<ButtonProps & { variant?: "default" | "glass" }> = ({ children, variant = "default", ...props }) => {
  return (
    <ButtonBase
      {...props}
      className={cn(
        "inline-block bg-primary px-4 py-2 font-bold text-accent transition-colors disabled:cursor-not-allowed disabled:opacity-50 rounded-md whitespace-nowrap",
